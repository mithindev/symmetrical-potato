<%@ Page Title="List of Loans" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="LoanList.aspx.vb" Inherits="Fiscus.LoanList" %>
                        ...
                        <div class="card-inner-group">
                                        ...
                                        <div class="nk-iv-wg3">
                                            ...
                                            <div class="nk-iv-wg3-group  flex-lg-nowrap gx-4">
                                                <div class="nk-iv-wg3-sub">
                                                    ...
                                                    <div class="nk-iv-wg3-subtitle">Loan Balance</div>
                                                </div>
                                            ...
                                            <div class="nk-iv-wg3-group flex-md-nowrap g-4">
                                                <div class="nk-iv-wg3-sub-group gx-4">
                                                    <div class="nk-iv-wg3-sub">
                                                        ...
                                                        <div class="nk-iv-wg3-subtitle">New Loan</div>
                                                    </div>
                                                <%--    <div class="nk-iv-wg3-sub"><span class="nk-iv-wg3-plus text-soft"><em class="icon ni ni-plus"></em></span>
                                                        <div class="nk-iv-wg3-amount">
                            ...
                            <div class="card-inner border-top ">
                                <ul class="nk-iv-wg3-nav">
                                    <li><asp:LinkButton runat="server"  ID="btnDCL"> <em class="icon ni ni-report-profit "></em><p>DCL&nbsp;</p></asp:LinkButton></li>
                                    <li><asp:LinkButton runat="server"  ID="btnDL"> <em class="icon ni ni-report-profit "></em><p>DL&nbsp;</p></asp:LinkButton></li>
                                    <li><asp:LinkButton runat="server"  ID="btnJL"> <em class="icon ni ni-report-profit "></em><p>JL&nbsp;</p></asp:LinkButton></li>
                                    <li><asp:LinkButton runat="server"  ID="btnML"> <em class="icon ni ni-report-profit "></em><p>ML&nbsp;</p></asp:LinkButton></li>
                    ...
                    <div class="nk-iv-scheme-list">
                        <asp:Repeater runat="server" ID="rpAPlan">
                            ...
                            <div class="nk-iv-scheme-info">
                                <div class="nk-iv-scheme-name"><asp:Label ID="lblacn" runat="server" Text='<%# Eval("acno") %>' ></asp:Label>&nbsp;&nbsp;<span class="badge badge-primary "><%# Eval("sch") %></span> </div>
                            ...
                            <div class="nk-iv-scheme-term">
                                <div class="nk-iv-scheme-start nk-iv-scheme-order"><span class="nk-iv-scheme-label text-soft">Loan Date</span><span class="nk-iv-scheme-value date"><asp:Label ID="lbldate" runat="server" Text='<%# Eval("date", "{0:dd MMM yyyy}") %>' ></asp:Label></span></div>
                                <div class="nk-iv-scheme-end nk-iv-scheme-order"><span class="nk-iv-scheme-label text-soft">Days</span><span class="nk-iv-scheme-value date"><asp:Label ID="lblmdate" runat="server" Text='<%# Eval("term") %>' ></asp:Label></span></div>
                            </div>
                            <div class="nk-iv-scheme-amount">
                                <div class="nk-iv-scheme-amount-a nk-iv-scheme-order"><span class="nk-iv-scheme-label text-soft">Rate Per Gram</span><span class="nk-iv-scheme-value amount"><asp:Label ID="lblrpg" runat="server" Text='<%# Eval("rpg", "{0:C}") %>' ></asp:Label></span></div>
                            ...
                            <a class="btn btn-icon btn-lg btn-round btn-trans" target="_blank"     href="SoaLoan.aspx?acno=<%# Eval("acno") %>"><em class="icon ni ni-forward-ios"></em></a>
                        ...
                        <div class="nk-iv-scheme-item">
                          ...
                          <div class="nk-iv-scheme-info">
                            ...
                            <div class="nk-iv-scheme-term">
                                ...
                                <div class="nk-iv-scheme-end nk-iv-scheme-order"><span class="nk-iv-scheme-label text-soft">End Date</span><span class="nk-iv-scheme-value date"><asp:Label ID="lblmdate" runat="server" Text=""></asp:Label></span></div>
                            </div>
                            <div class="nk-iv-scheme-amount">
                                <div class="nk-iv-scheme-amount-a nk-iv-scheme-order"><span class="nk-iv-scheme-label text-soft">&nbsp;</span><span class="nk-iv-scheme-value amount"><asp:Label ID="lblmamt" runat="server" Text="" ></asp:Label></span></div>
                                <div class="nk-iv-scheme-amount-b nk-iv-scheme-order"><span class="nk-iv-scheme-label text-soft">Balance</span><span class="nk-iv-scheme-value amount"><asp:Label ID="lblbal" runat="server" Text='<%# Eval("bal", "{0:C}") %>' ></asp:Label></span></div>
                            </div>
                            <div class="nk-iv-scheme-more"><a class="btn btn-icon btn-lg btn-round btn-trans" target="_blank"     href="SoaLoan.aspx?acno=<%# Eval("acno") %>"> <em class="icon ni ni-forward-ios"></em></a></div>
