<%@ Page Title="Trial Balance" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="TrialBalance.aspx.vb" Inherits="Fiscus.TrialBalance" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link rel="stylesheet" href="../css/daterangepicker.css" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="trialbal" runat="server">
          ...
          <asp:UpdatePanel runat="server" >
              <ContentTemplate>
                  <div class="card card-body ">
                      <h6 class="card-title text-primary ">Trial Balance</h6>
                                ...
                                <Columns>
                                    ...
                                    <asp:Label ID="lbl_dr" runat="server" text='<%#Eval("debit", "{0:N}")%>' Style="text-align:right;float:right ;font-size:smaller "></asp:Label>
                                        ...
                                        <ItemStyle Width ="20%" />
                                                             ...
                                                             <asp:UpdatePanel runat ="server">
                        <ContentTemplate>                            <table style="width:100%;margin-left:0px;float :left " class ="table table-bordered  ">
    ...
    <asp:ImageButton runat="server" style="margin-left:0px" Width ="45px" Height="34px"  ImageUrl="../images/search_logo.png" id="btn_show" CssClass="btn btn-outline-secondary  "   />
                        ...
                        <ContentTemplate>                            <table style="border:1px;width:100%;margin-left:0px;float :left " class ="customers ">
