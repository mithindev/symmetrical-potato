<%@ Page Title="Receipt" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/Admin.Master" CodeBehind="GlReceipt.aspx.vb" Inherits="Fiscus.GlReceipt" %>
						...
						<div class="card">
							<div class="card-body">
								<div class="form-group row ">
									...
									<div class="col-sm-3">
										<asp:TextBox runat="server" CssClass="form-control"   ID="tdate" data-validation-engine="validate[required,funcCall[DateFormat[]]" data-errormessage-value-missing="Date Missing" ></asp:TextBox>
									</div>
									</div>
								<div class="form-group row">
